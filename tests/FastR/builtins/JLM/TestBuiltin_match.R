...
{ match(F, c(1+0i, 0+0i)) }
{ match(T, c(1+0i,0+0i)) }
{ match(c(T, F), c(1+0i, 0+0i)) }
{ match(T, as.raw(1)) }
{ match(T, as.raw(c(1, 0))) }
{ match(c(T,F), as.raw(1)) }
{ match(c(T,F), as.raw(c(1, 0))) }
{ match(T, 'TRUE') }
{ match(T, c('TRUE', 'FALSE')) }
{ match(c(T,F), 'TRUE') }
{ match(c(T,F), c('TRUE', 'FALSE')) }
{ match(as.raw(1), as.raw(1)) }
{ match(as.raw(1), as.raw(c(1, 0))) }
{ match(as.raw(c(1,0)), as.raw(1)) }
{ match(as.raw(c(1,0)), as.raw(c(1, 0))) }
{ match(as.raw(16), 10) }
{ match(as.raw(c(16, 17)), 10) }
{ match(as.raw(16), c(16, 11)) }
{ match(as.raw(c(16, 17)), c(10,11)) }
{ match(as.raw(16), 10L) }
{ match(as.raw(c(16, 17)), 10L) }
{ match(as.raw(16), c(16, 11L)) }
{ match(as.raw(c(16, 17)), c(10L,11L)) }
{ match(as.raw(1), T) }
{ match(as.raw(c(1, 0)), T) }
{ match(as.raw(1), c(T,F)) }
{ match(as.raw(c(1, 0)), c(T,F)) }
{ match(as.raw(0:255), c(F, T)) }
{ match(as.raw(16), '10') }
{ match(as.raw(c(16, 17)), '10') }
{ match(as.raw(16), c('10', '11')) }
{ match(as.raw(c(16, 17)), c('10', '11')) }
{ match(as.raw(16), 10+0i) }
{ match(as.raw(c(16, 17)), 10+0i) }
{ match(as.raw(16), c(10+0i, 11+0i)) }
{ match(as.raw(c(16, 17)), c(10+0i, 11+0i)) }
{ match(as.raw(0:255), complex(real=0:255, imaginary=0)) }
{ match(1L, 1L) }
{ match(0L, c(1L, 0L)) }
{ match(c(1L, 0L), 1L) }
{ match(c(1L, 0L), c(1L, 0L)) }
{ match(1L, T) }
{ match(0L, c(T, F)) }
{ match(c(1L, 0L), T) }
{ match(c(1L, 0L), c(T, F)) }
{ match(10L, as.raw(16)) }
{ match(10L, as.raw(c(16, 17))) }
{ match(c(10L, 11L), as.raw(16)) }
{ match(c(10L, 11L), as.raw(c(16, 17))) }
{ match(1L, 1) }
{ match(1L, c(1, 0)) }
{ match(c(1L,0L), 1) }
{ match(c(1L,0L), c(1, 0)) }
{ match(1L, 1+0i) }
{ match(1L, c(1+0i, 0+0i)) }
{ match(c(1L,0L), 1+0i) }
{ match(c(1L,0L), c(1+0i, 0+0i)) }
{ match(1L, '1') }
{ match(1L, c('1', '0')) }
{ match(c(1L,0L), '1') }
{ match(c(1L,0L), c('1', '0')) }
...
{ match(c(1, 0), c(T, F)) }
{ match(10, as.raw(16)) }
{ match(10, as.raw(c(16, 17))) }
{ match(c(10, 11), as.raw(16)) }
{ match(c(10, 11), as.raw(c(16, 17))) }
{ match(1, 1L) }
{ match(0, c(1L, 0L)) }
{ match(c(1, 0), 1L) }
{ match(c(1, 0), c(1L, 0L)) }
...
{ match(0, c(1+0i, 0+0i)) }
{ match(c(1, 0), 1+0i) }
{ match(c(1, 0), c(1+0i, 0+0i)) }
{ match(1, '1') }
{ match(0, c('1', '0')) }
{ match(c(1, 0), '1') }
{ match(c(1, 0), c('1', '0')) }
{ match(1+0i, 1+0i) }
{ match(1+0i, c(1+0i, 0+0i)) }
{ match(c(1+0i,0+0i), 1+0i) }
{ match(c(1+0i,0+0i), c(1+0i, 0+0i)) }
{ match(1+0i, T) }
{ match(1+0i, c(T, F)) }
{ match(c(1+0i,0+0i), T) }
{ match(c(1+0i,0+0i), c(T, F)) }
{ match(10+0i, as.raw(16)) }
{ match(10+0i, as.raw(c(16, 17))) }
{ match(c(10+0i,11+0i), as.raw(16)) }
{ match(c(10+0i,11+0i), as.raw(c(16, 17))) }
{ match(10+0i, 10L) }
{ match(10+0i, c(10L, 11L)) }
{ match(c(10+0i,11+0i), 10L) }
{ match(c(10+0i,11+0i), c(10L, 11L)) }
{ match(10+0i, 10) }
{ match(10+0i, c(10, 11)) }
{ match(c(10+0i,11+0i), 10) }
{ match(c(10+0i,11+0i), c(10, 11)) }
{ match(10+0i, '10') }
{ match(10+0i, c('10', '11')) }
{ match(c(10+0i,11+0i), '10') }
{ match(c(10+0i,11+0i), c('10', '11')) }
...
{ match('TRUE', T) }
{ match('TRUE', c(T, F)) }
{ match(c('TRUE', 'FALSE'), T) }
{ match(c('TRUE', 'FALSE'), c(T, F)) }
{ match('10', as.raw(16)) }
{ match('10', as.raw(c(16, 17))) }
{ match(c('10', '11'), as.raw(16)) }
{ match(c('10', '11'), as.raw(c(16, 17))) }
...
{ match(c('1+0i', '0+0i'), 1+0i) }
{ match(c('1+0i', '0+0i'), c(1+0i, 0+0i)) }
{ match(c(-2L, -1L, 0L, 1L, 10L, 11L), seq.int(from=-1L, to=10L, by=1L)) }
{ match(c( 1L, 2L, 3L), seq.int(from=1L, to=10L, by=2L)) }
{ match(seq.int(from=1L, to=10L, by=1L), seq.int(from=1L, to=10L, by=4L)) }
