...
Inductive BLE : Type :=
  ...
  | BLELgl : nat (** Length of the array **) -> BLE list (** A pointer to the values of the array **) -> BLE (** A vector containing logical values **)
  | BLEInt : nat (** Length of the array **) -> BLE list (** A pointer to the values of the array **) -> BLE (** A vector containing logical values **)
  | BLEReal : nat (** Length of the array **) -> BLE list (** A pointer to the values of the array **) -> BLE (** A vector containing double-precision values **)
  | BLECplx : nat (** Length of the array **) -> BLE list (** A pointer to the values of the array **) -> BLE (** A vector containing double-precision complex values **)
  | BLEStr : nat (** Length of the array **) -> BLE list (** A pointer to the values of the array **) -> BLE (** A vector containing character values **)
  ...
  | BLEVec : nat (** Length of the array **) -> BLE list (** A pointer to the values of the array **) -> BLE (** Generic vectors **)
  | BLEExpr : nat (** Length of the array **) -> BLE list (** A pointer to the values of the array **) -> BLE (** Expression vectors vectors **)
