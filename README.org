...
[here for Opam](http://coq.io/opam/get_started.html)
and [here for Git](https://git-scm.com/).
#+BEGIN_SRC bash
    sudo apt install opam aspcud git
#+END_SRC
...
The following line ensures that the Coq repository is known by Opam.
#+BEGIN_SRC bash
